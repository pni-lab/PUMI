...
"""
    rcpl_light.py is an RCPL pipeline without fieldmap correction and functional to sbref registration.
"""
...
def rcpl(wf, bbr=True, **kwargs):
    ...
    wf.connect(reorient_func_wf, 'out_file', predict_pain_sensitivity_rpn_wf, 'in_file')
    ...
    wf.connect(reorient_func_wf, 'out_file', predict_pain_sensitivity_rcpl_wf, 'in_file')
