...
def rcpl(wf, bbr=True, **kwargs):
    ...
    reorient_phasediff_img_wf = Node(Reorient2Std(output_type='NIFTI_GZ'), name="reorient_phasediff_img_wf")
    wf.connect('inputspec', 'phasediff_img', reorient_phasediff_img_wf, 'in_file')
    ...
    wf.connect('inputspec', 'bold_json', fieldmap_correction, 'main_json')
    ...
    wf.connect(reorient_struct_wf, 'out_file', fieldmap_correction, 'anat_img')
    ...
    wf.connect(fieldmap_correction, 'out_file', func2anat_wf, 'func')
    ...
    wf.connect(fieldmap_correction, 'out_file', func_proc_wf, 'func')
