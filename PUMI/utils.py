...
def plot_roi(roi_img, bg_img=None, cut_coords=None, output_file=None, display_mode='mosaic', figure=None, axes=None,
    ...
    Here a mosaic plot is generated by default, the background of every plot is black and the default cmap has been
    changed.
