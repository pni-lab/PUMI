...
brain_extraction = bet_hd('brain_extraction')
wf.connect(reorient, 'out_file', brain_extraction, 'in_file')

# transform to MNI
anat2mni = anat2mni_ants_hardcoded('anat2mni')
wf.connect(brain_extraction, 'out_file', anat2mni, 'brain')
wf.connect(reorient, 'out_file', anat2mni, 'head')
