...
output_dir = os.path.join(ROOT_DIR, 'data_out')  # path where the output-folder will be created (the results)
working_dir = os.path.join(ROOT_DIR, 'data_out')  # path where the folder workflow-folder will be created
